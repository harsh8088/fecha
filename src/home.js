            ...
            <div className="home-container">
                <div className="card-container">
                    ...
                    <div className="img-action-container">
                        <img className="img-dislike" src={dislike} onClick={(e) => this.handleClick(false, e)} />
                        <img className="img-like" src={like} onClick={(e) => this.handleClick(true, e)} />
                    </div>
                </div>
            </div>
        );
...
function ListItem(props) {
    ...
    return <div><img className="img-container"
